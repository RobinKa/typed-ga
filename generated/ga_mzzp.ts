...
export const geometricProduct = <A extends OptionalMultiVector, B extends OptionalMultiVector>(a: A, b: B): GeometricProductResultType<A, B> => {
    ...
    const scalar_2 = a.e3 && b.e3
    const scalar_3 = a.e03 && b.e03
    if (scalar_0 || scalar_1 || scalar_2 || scalar_3) {
        ...
        if (scalar_2) resultScalar += 1.0 * (a.e3! * b.e3!)
        if (scalar_3) resultScalar += 1.0 * (a.e03! * b.e03!)
    }
    let resultE0 = undefined
    const e0_0 = a.scalar && b.e0
    const e0_1 = a.e0 && b.scalar
    const e0_2 = a.e3 && b.e03
    const e0_3 = a.e03 && b.e3
    if (e0_0 || e0_1 || e0_2 || e0_3) {
        resultE0 = 0
        if (e0_0) resultE0 += 1.0 * (a.scalar! * b.e0!)
        if (e0_1) resultE0 += 1.0 * (a.e0! * b.scalar!)
        if (e0_2) resultE0 += -1.0 * (a.e3! * b.e03!)
        if (e0_3) resultE0 += 1.0 * (a.e03! * b.e3!)
    }
    ...
    const e3_2 = a.e3 && b.scalar
    const e3_3 = a.e03 && b.e0
    if (e3_0 || e3_1 || e3_2 || e3_3) {
        resultE3 = 0
        if (e3_0) resultE3 += 1.0 * (a.scalar! * b.e3!)
        if (e3_1) resultE3 += -1.0 * (a.e0! * b.e03!)
        if (e3_2) resultE3 += 1.0 * (a.e3! * b.scalar!)
        if (e3_3) resultE3 += 1.0 * (a.e03! * b.e0!)
    }
